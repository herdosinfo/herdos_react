...
* **Current Status**: Hero cinematic scroll-storytelling redesign complete and verified clean with production build.
* **What to do next**: Perform final visual review on local dev server (`npm run dev`) and commit changes.
